...
def create_cubic_polyfit(x,y,z,funcname,x_name="crude_x", y_name = "crude_y"):
...
def create_4th_polyfit(x,y,z,funcname,x_name="crude_x", y_name = "crude_y"):
    func_file = open(funcname+".py", 'w')
    func_file.write("#!/usr/bin/env python\n#-*- coding:utf-8 -*-\n")
    func_file.write("def " + funcname + "(" + x_name + "," + y_name + "):\n")
    def fit(x,y, params):
