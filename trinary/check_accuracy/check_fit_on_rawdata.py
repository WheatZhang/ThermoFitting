...
csv_data = pd.read_csv("dataset_design/42__Main Tower.csv", sep=',')
...
for r in range(csv_data.shape[0]):
    ...
    vap_etlp = csv_data.loc[r, 'vap_etlp']
    liq_etlp = csv_data.loc[r, 'liq_etlp']
...
fp = open("AccuracyOnRawReport.txt",'w')
